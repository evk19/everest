...
export class AuthService {
  ...
  isSherpa$: Observable<boolean> = this.user$.pipe(
    map((user) => !!user.isSherpa)
  );
  isClimber$: Observable<boolean> = this.user$.pipe(
    map((user) => !!user.isClimber)
  );
